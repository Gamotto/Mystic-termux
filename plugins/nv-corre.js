...
let vn = './media/corre.mp3'
conn.sendPresenceUpdate('recording', m.chat)
conn.sendMessage(m.chat, { audio: { url: vn }, seconds: '1934.4', ptt: true, mimetype: 'audio/mpeg', fileName: `corre.mp3` }, { quoted: m })}
handler.customPrefix = /corre|CORRE|Corre/
handler.command = /^(corre|CORRE|Corre?$)/
